...
| result | headline |
|---|---|
| [resume_dip_not_visible_in_production_RESULT.md](resume_dip_not_visible_in_production_RESULT.md) | The resume dip is invisible to the absolute ruler but REAL on the paired instrument — 0.362 at generation 108 |
...
| file | headline |
|---|---|
| [budget_18000_PREREG.md](budget_18000_PREREG.md) | PRE-REGISTRATION — does a LARGER, more stable budget avoid the harm? |
