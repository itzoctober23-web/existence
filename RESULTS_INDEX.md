...
| [gate_candidates_are_game_neutral_RESULT.md](gate_candidates_are_game_neutral_RESULT.md) | the gate's own candidates are 14.3% decisive against 31-42% for two reference programs (z=2.41, z=3.68) — the registered "mate guard selects for game-neutrality" mechanism survived its falsifier |
